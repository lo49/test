...
// Filtre : 
#define UNICAST	 	 	0x01	// For TCP/UDP
#define BROADCAST		0x02	// For ICMP/ARP
#define MAC_IP_UDP_FILTER 	 0x03
#define MAC_IP_ICMP_FILTER 	 0x04
// functions
